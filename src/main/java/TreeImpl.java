...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E> {
    ...
    public int deep(){
        ...
        leftDeep(root.getLeftChild(),1);
        rightDeep(root.getRightChild(),1);
    ...
    private void leftDeep(Node<E> current,int lvl) {
        ...
        leftDeep(current.getLeftChild(),lvl);
        leftDeep(current.getRightChild(),lvl);
    }

    private void rightDeep(Node<E> current,int lvl) {
        if (current == null || current == root) {
            return;
        }
        lvl++;
        ...
        rightDeep(current.getRightChild(),lvl);
        rightDeep(current.getLeftChild(),lvl);
    }
